...
# Unit tests for TriglavClientBase::MessageApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MessageApi' do
  before do
    # run before each test
    @instance = TriglavClientBase::MessageApi.new
  end
  ...
  describe 'test an instance of MessageApi' do
    it 'should create an instact of MessageApi' do
      expect(@instance).to be_instance_of(TriglavClientBase::MessageApi)
    end
  end
