...
- API version: 1.0.0
- Package version: 1.0.0.pre1
- Build date: 2017-03-08T22:32:07.369+09:00
...
```shell
gem install ./triglav_client-1.0.0.pre1.gem
```
(for development, run `gem install --dev ./triglav_client-1.0.0.pre1.gem` to install the development dependencies)

or publish the gem to a gem hosting service, e.g. [RubyGems](https://rubygems.org/).

Finally add this to the Gemfile:

    gem 'triglav_client', '~> 1.0.0.pre1'
