...
- Build date: 2017-02-08T16:42:35.790+09:00
...
```shell
gem install ./triglav_client-0.1.27.gem
```
(for development, run `gem install --dev ./triglav_client-0.1.27.gem` to install the development dependencies)

or publish the gem to a gem hosting service, e.g. [RubyGems](https://rubygems.org/).

Finally add this to the Gemfile:

    gem 'triglav_client', '~> 0.1.27'
