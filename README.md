...
- Build date: 2016-10-11T17:50:58.716+09:00
...
```shell
gem install ./triglav_client-0.1.0.gem
```
(for development, run `gem install --dev ./triglav_client-0.1.0.gem` to install the development dependencies)

or publish the gem to a gem hosting service, e.g. [RubyGems](https://rubygems.org/).

Finally add this to the Gemfile:

    gem 'triglav_client', '~> 0.1.0'
